...
def main():
    ...
    i2c = SoftI2C(sda=Pin(32),  # Here, use your I2C SDA pin
                  scl=Pin(33),  # Here, use your I2C SCL pin
    ...
    while True:
        ...
        if sensor.available():
            ...
            ggsheet.updateCell(1,1,red_reading)
            ggsheet.updateCell(1,2,ir_reading)
